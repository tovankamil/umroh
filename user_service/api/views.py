...
from .serializers import UserRegistrasiSerializer, UserUpdateSerializer, LoginSerializer, UserWithSponsorsSerializer
...
class UserWithSponsorsView(generics.RetrieveAPIView):
    queryset = CustomUser.objects.all()
    serializer_class = UserWithSponsorsSerializer
    ...
    def get_object(self):
        ...
        try:
            ...
            raise NotFound(f'User dengan username "{username}" tidak ditemukan')
